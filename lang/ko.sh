...
MSG_COMMON_ROOT_COMMIT_FMT='%s는 root commit입니다 (부모 없음); 이 작업은 root commit을 지원하지 않습니다.\n'
MSG_COMMON_ROOT_HINT="팁: root commit을 수정하려면 git rebase -i --root; HEAD가 root이면 git commit --amend 사용."
