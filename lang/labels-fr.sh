...
LABEL_BRANCH_CHECKOUT='Git · Aller sur branch'
LABEL_BRANCH_RENAME='Git · Renommer branch'
LABEL_COPY_BRANCH_NAME='Git · Copier nom de branch'
LABEL_COPY_COMMIT_MSG='Git · Copier message commit'
