...
MSG_LIB_PRESS_ENTER="── press Enter to close ──"
...
MSG_COMMON_ROOT_COMMIT_FMT='%s is the root commit (no parent); this operation does not support root commits.\n'
MSG_COMMON_ROOT_HINT="Tip: use git rebase -i --root to edit it, or git commit --amend if HEAD is the root."
